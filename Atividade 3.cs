...
namespace ArvoreBinaria {
	...
	//Codigo da atv em sí começa AQUI:

	class geradoraDeArvore : ArvoreBinaria {	//Herdando, como requisitado

		public void Main() {
			CriarArvore();  //Funcao herdada
			...
			while (true) {
				Console.WriteLine();
				Console.Write("1- Inserir. 2 - Remover\n3- PreOrdem\n4-Ordem\n5-PosOrdem\n\nElse-Sair\n\n");

				int opcao = Console.Read();
				opcao -= 48;    //'1' = 49 em ASCII

				if (opcao == 1) {
					Console.Write("Inserir a letra: ");
			...
			//Fiz tudo manualmente pois o Command Buffer do teclado não estava cooperando
			//Ele nao quer ler as entradas do teclado, passa direto

			//Como pode  ver, as operacoes de insercao, remocao e etc funcionam sem problema
		}
	}

	public class mainClass {
		static void Main(string[] args) {
			geradoraDeArvore gerador = new geradoraDeArvore();
